...
class ReservationAdminController extends Controller
{
    ...
    {
        $user = Auth::user();
        return view('admin.createreservation',['user'=>$user, 'id'=>$id]);
    }
    ...
    public function show(string $id)
    {
        ...
        ->where('date_reservation','>=',now())->paginate(5);

        return view('admin.reservationshow',['reservations'=>$reservations,'user'=>$user, 'id'=>$id]);
    }
